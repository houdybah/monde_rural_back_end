...
public interface RegionAdministrativeRepository extends CrudRepository<RegionAdministrative, String> {

    @Query("select c from RaceFamille c")
    Page<RegionAdministrative> findAll(Pageable pageable);
    ...
    Page<RegionAdministrative> findAllKeyed(Pageable pageable, @Param("key") String key );
